...
st.set_page_config(
    page_title="Dashboard Sharing Sepeda",
    layout="wide"
)

# Judul dashboard
st.title("Dashboard Bycycle Sharing Analysis")
...
def load_data():
    ...
    if not os.path.exists(csv_path):
        st.error(f"File {csv_path} tidak ditemukan! Pastikan day.csv ada di direktori yang benar.")
